...
const save=(event)=>{
	...
	axios.put(urladd,{eid,name,gender,sal,phone,dept})
	.then(res=>{
...
<form onSubmit={save}>
<input type="number" placeholder="enter eid" ref={rId} onChange={hEid} min="1" value={eid} required/>
<br/><br/>
...
<br/><br/>
<input type="number" placeholder="enter salary (in $)" ref={rSal} min="8000" value={sal} onChange={hSal} required/>
<br/><br/>
<input type="number" placeholder="enter phone no" max_length="10" value={phone} min="1000000000" onChange={hPhone} required/>
<br/><br/>
